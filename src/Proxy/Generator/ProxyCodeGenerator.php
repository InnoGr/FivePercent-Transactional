...
class ProxyCodeGenerator
{
        ...
        foreach ($methods as $method) {
            ...
            if (strpos($docComment, 'Transactional') !== false) {
                $annotation = $this->annotationReader->getMethodAnnotation(
                    $method,
                    'FivePercent\Component\Transactional\Annotation\Transactional'
                );
    ...
    private function getAllUseStatementsMarkedAsAnnotation(\ReflectionClass $class)
    {
        ...
        $useFiltering = function ($class, $searchChild = true) use (&$useFiltering) {
            ...
            if ($reflection->getName() == 'FivePercent\Component\Transactional\Annotation\Transactional') {
                return false;
            }
    ...
    private function generateProxyClass()
    {
        ...
        $uses[] = 'FivePercent\Component\Transactional\Proxy\ProxyInterface as FivePercentTransactionalProxyInterface';
        ...
        $interfaces = [
            'FivePercentTransactionalProxyInterface'
        ];
...
{
    /**
     * @var \FivePercent\Component\Transactional\TransactionalInterface
     */
     ...
     * Set transactional
     *
     * @param \FivePercent\Component\Transactional\TransactionalInterface \$transactional
     */
    public function ___setTransactional(\FivePercent\Component\Transactional\TransactionalInterface \$transactional)
    {
